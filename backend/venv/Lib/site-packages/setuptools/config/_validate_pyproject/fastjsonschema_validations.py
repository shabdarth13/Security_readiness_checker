        ...
        if "dynamic" in data_keys:
            ...
            if data__dynamic_is_dict:
                ...
                if "entry-points" in data__dynamic_keys:
                    ...
                    validate_https___setuptools_pypa_io_en_latest_references_keywords_html__definitions_file_directive(data__dynamic__entrypoints, custom_formats, (name_prefix or "data") + ".dynamicnamery-points")
