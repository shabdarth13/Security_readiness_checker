...
class ThemeContext:
    ...
    def __exit__(
        self,
        exc_type: OptionPageype[BaseException]],
        exc_val: Optional[BaseException],
        exc_tb: Optional[TracebackType],
    ) -> None:
    ...
    def rule(
        ...
        *,
        ...
        Args:
            ...
            characters (str, optional): Character(s)l_coform the line. Defaults to "─".
        ...
        *,
        ...
        Args:
            ...
            code_format (str, optional): Format string used to generate the SVG. Rich will inject a number of variables
                into the string t nerder to form the final SVG output. The default template used and the variables
